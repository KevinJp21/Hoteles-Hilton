...
<div class="contenedor">
                ...
                <div class="row main">
                        ...
                        <div class="container-location">
                            <a href="#" class="location"><svg class="location-svg" xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <symbol viewBox="0 0 14 20" id="45093">
                                        ...
                                        <g fill="currentColor">
                                            <path
                                                d="M7,10.8c-1.7,0-3-1.4-3-3.2c0-1.8,1.3-3.2,3-3.2c1.7,0,3,1.4,3,3.2C10,9.4,8.7,10.8,7,10.8 M14,7.6    C14,3.4,10.9,0,7,0S0,3.4,0,7.6c0,2.1,0.8,4,2.1,5.4l0,0l5,7l5-7l0,0C13.2,11.6,14,9.7,14,7.6">
                                            </path>
                                        </g>
                                    </symbol>
                                    <use xlink:href="#45093"></use>
                                </svg>
                    ...
                    <div class="col-3 container-3-3">
                        ...
                        <div class="container-search">
                            <a href="#" class="search"><svg class="search-svg" xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 33 33">
                                    <symbol viewBox="0 0 33 33" id="95956">
                                        <title>search-circle</title>
                                        <g id="search-circle-search" fill="currentColor">
                                            <path class="design-in"
                                                d="M14.90625,19.2484472 C12.75,19.2484472 10.96875,17.3850932 10.96875,15.1490683 C10.96875,12.9130435 12.75,11.0496894 14.90625,11.0496894 C17.0625,11.0496894 18.84375,12.9130435 18.84375,15.1490683 C18.9375,17.3850932 17.15625,19.2484472 14.90625,19.2484472 Z M20.0625,18.3167702 C20.625,17.3850932 20.90625,16.2670807 20.90625,15.1490683 C20.90625,11.7018634 18.28125,9 14.90625,9 C11.625,9 9,11.7018634 9,15.1490683 C9,18.5031056 11.625,21.2981366 14.90625,21.2981366 C16.21875,21.2981366 17.53125,20.8322981 18.46875,20.0869565 L22.3125,24 L24,22.5093168 L20.0625,18.3167702 Z"
                                                id="search-circle-search1"></path>
                                            <path class="design-out"
                                                d="M16.5,0 C7.38644476,0 0,7.38644476 0,16.5 C0,25.6135552 7.38644476,33 16.5,33 C25.6135552,33 33,25.6121856 33,16.5 C33,7.38781439 25.6121856,0 16.5,0 Z M16.5,30.4223458 C8.81086578,30.4223458 2.57765419,24.1905039 2.57765419,16.5 C2.57765419,8.80949614 8.80949614,2.57765419 16.5,2.57765419 C24.1905039,2.57765419 30.4223458,8.80949614 30.4223458,16.5 C30.4223458,24.1905039 24.1891342,30.4223458 16.5,30.4223458 Z"
                                                id="search-circle-search2"></path>
                                        </g>
                                    </symbol>
                                    <use xlink:href="#95956"></use>
                                </svg>
                            </a>
                        </div>
                    </div>
        ...
        <div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel"
            data-bs-interval="7000" data-bs-pause="none">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active c-item">
                        ...
                        <div class="carousel-caption top-0 mt-5 cc">
                            <p class="mt-5 display-4 text-uppercase">Disfrute de una experiencia de lujo en nuestro
                                resort.</p>
                            <button class="btn btn-primary px-4 py-2  mt-5 btn-c"> <a class="fs-2"
                                    href="#heading">Cotizar</a></button>
                        </div>
                    </div>
                    ...
                    <div class="carousel-item c-item">
                        ...
                        <div class="carousel-caption top-0 mt-5 cc">
                            <p class="mt-5 display-4 text-uppercase">Ofrecemos habitaciones compartidas y privadas a
    ...
    <footer id="footer" class="mt-5">
        <div class="footer">
            ...
            <a href="https://github.com/KevinJp21?tab=repositories"><svg xmlns="http://www.w3.org/2000/svg"
