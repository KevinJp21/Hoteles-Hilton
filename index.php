...
class Hostal extends Hotel {
    ...
    public function imprimirFormulario() {
        echo '<h2>HOSTAL</h2>';
        //echo '<img src="images/hostal.jpg" alt="Hostal Hilton">';
        echo '<form action="index.php" method="post">';
        echo '<input type="number" name="numero_personas" placeholder="Número de personas">';
        echo '<input type="number" name="numero_dias" placeholder="Número de días">';
...
class Posada extends Hotel {
    ...
    public function imprimirFormulario() {
        echo '<h2>POSADA</h2>';
        //echo '<img src="images/posada.jpg" alt="Posada Hilton">';
        echo '<form action="index.php" method="post">';
        echo '<input type="number" name="numero_personas" placeholder="Número de personas">';
        echo '<input type="number" name="numero_dias" placeholder="Número de días">';
        echo '<input type="checkbox" name="desayuno" value="1">Incluir desayuno';
        echo '<input type="submit" value="Enviar">';
        echo '</form>';
    }
}
...
class Resort extends Hotel {
    ...
    public function imprimirFormulario() {
        echo '<h2>RESORT</h2>';
        //echo '<img src="../Hoteles_Hilton/img/resort.jpg" alt="Resort Hilton">';
        echo '<form action="index.php" method="post">';
        echo '<input type="number" name="numero_personas" placeholder="Número de personas">';
        echo '<input type="number" name="numero_dias" placeholder="Número de días">';
        echo '<input type="checkbox" name="todo_incluido" value="1">Plan todo incluido';
        echo '<input type="submit" value="Enviar">';
        echo '</form>';
    }
}
...
<div class="container-topbar">
                <div class="topbar">
                    <div class="container-bar-elements">
                        <div class="bars">
                            <div class="line"></div>
                            <div class="line"></div>
                            <div class="line"></div>
    ...
    <div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="7000" data-bs-pause="hover">
  <div class="carousel-inner">
    <div class="carousel-item active c-item">
      ...
      <p class="mt-5 display-4 text-uppercase">Disfrute de una experiencia de lujo en nuestro resort.</p>
        <button class="btn btn-primary px-4 py-2 fs-2 mt-5">Reservar</button>
      </div>
    </div>
  ...
  <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleFade" data-bs-slide="next">
    ...
    <form action="index.php" method="post">
        <input type="number" name="precio" placeholder="Ingrese el costo por noche">
